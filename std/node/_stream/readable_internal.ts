...
function maybeReadMore(stream: Duplex | Readable, state: ReadableState) {
...
function maybeReadMore_(stream: Duplex | Readable, state: ReadableState) {
  while (
...
function onEofChunk(stream: Duplex | Readable, state: ReadableState) {
